...
//     struct address_v6::bytes_type : array<unsigned char, 4>
//     {
...
int main()
{
    static_assert((sizeof( ip::address_v6::bytes_type) == 16), "" );
    static_assert((std::is_standard_layout<ip::address_v6::bytes_type>::value), "" );
}
